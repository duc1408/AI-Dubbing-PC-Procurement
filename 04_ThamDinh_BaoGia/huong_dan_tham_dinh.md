...
👉 **Lấy toàn bộ nội dung System Prompt chuẩn tại đây:** [system_prompt_gemini_gem.md](system_prompt_gemini_gem.md)

Bạn chỉ cần mở file trên, copy toàn bộ nội dung và dán vào phần "Instructions" khi tạo Gem trên Google Gemini (hoặc Custom GPTs). Siêu trợ lý của bạn sẽ lập tức sẵn sàng chiến đấu!
