...
| **RAM** | Tổng GB, Tốc độ MHz | **Toc do** & **TONG DUNG LUONG** | Tốc độ MHz phải bằng hoặc cao hơn báo giá (VD: 5200 MHz). Cảnh giác với RAM hãng lạ không có tên tuổi. |
| **Ổ cứng** | Tên hãng, Chuẩn Gen 4, Dung lượng | **Ma Model** & **Tinh trang SMART** | Tình trạng SMART phải là `OK`. Hãy copy Mã Model lên Google kiểm tra xem có đúng là Gen 4 và có TBW cao như thỏa thuận không. |
| **GPU** | RTX 4060Ti/4090, Dung lượng VRAM | **Ten Card** & **VRAM thuc te tu NVIDIA** | Lệnh NVIDIA phải báo thông số VRAM thực tế khớp với file yêu cầu (VD: `16384 MiB` cho Card 16GB). |
...
1. **Nguồn (PSU):** Dùng đèn pin rọi vào đít máy, nhìn xem tem nhãn có ghi hãng nổi tiếng (Corsair/FSP) và có logo `80 Plus Gold` không.
